...
Route::prefix('hris')->group(function () {
    Route::get(
        '/delete-employee',
        [AttendancesController::class, 'indexDeleteEmployee']
    )->name('hris.attendance.delete_employee.index');

    Route::get(
        '/attendance/ajax/employee-list',
        [AttendancesController::class, 'ajaxEmployeeList']
...
Route::group(['middleware' => ['auth.admin', 'lock'], 'prefix' => 'hris', 'namespace' => 'Hris'], function () {
    ...
    Route::post('/flni/deleteNonIstirahat', ['as' => 'flni.deleteNonIstirahat', 'uses' => 'FormLembur\FormLemburNonIstirahatController@deleteNonIstirahat']);
    Route::get('/flni/getNoForm', ['as' => 'flni.getNoForm', 'uses' => 'FormLembur\FormLemburNonIstirahatController@getNoForm']);
    ...
    Route::post('/ga/realisasi_pengajuan_perbaikan_kendaraan/{id}', ['as' => 'hris.ga.realisasi_pengajuan_perbaikan_kendaraan', 'uses' => 'PemeliharaanKendaraanController@realisasi_pengajuan_perbaikan_kendaraan']);
