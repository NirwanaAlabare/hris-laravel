...
class PermintaanTransportasi extends Model
{
    ...
    protected $fillable = ['id', 'enroll_id', 'id_desa', 'detail_alamat', 'id_desa_tujuan','detail_alamat_tujuan','tanggal_pemberangkatan','jam_pemberangkatan','tanggal_kedatangan','jam_kedatangan','tujuan_pemberangkatan','jarak_tempuh','nama_tamu','instansi_tamu','nomor_hp_tamu','jenis_barang','quantity','satuan','nama_instansi','nama_penerima','keterangan_barang','created_by','status'];
    protected $casts = [
