    ...
    public function ajax_exportexcel(Request $request)
    {
        ...
        foreach($dataAbsen as $Kehadiran) {
            ...
            $data = [
                ...
                $total_lembur_1234,
                "",
                $Kehadiran->lembur1_rupiah ? (int)$Kehadiran->lembur1_rupiah : "",
                $Kehadiran->lembur2_rupiah ? (int)$Kehadiran->lembur2_rupiah : "",
                $Kehadiran->lembur3_rupiah ? (int)$Kehadiran->lembur3_rupiah : "",
                $Kehadiran->lembur4_rupiah ? (int)$Kehadiran->lembur4_rupiah : "",
                $Kehadiran->total_lembur_rupiah ? (int)$Kehadiran->total_lembur_rupiah : "",
                "",
                $final_mulai_jam_lembur,
                $final_akhir_jam_lembur,
                $final_jam_istirahat,
