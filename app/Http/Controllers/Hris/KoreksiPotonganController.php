...
class KoreksiPotonganController extends AdminBaseController
{
    ...
    public function ajax_getnomorspl_potongan(Request $request)
    {
                ...
                foreach ($collect as $key => $value) {
                   $findDT = DataKoreksiPotongan::where('enroll_id',$value['enroll_id'])->where('periode_tanggal_koreksi',$value['periode_tanggal_koreksi'])
                    ...
                    if($findDT){
                        ...
                        DataKoreksiPotongan::where('enroll_id',$value['enroll_id'])->where('periode_tanggal_koreksi',$value['periode_tanggal_koreksi'])->where('jenis_potongan',$value['jenis_potongan'])->where('tanggal_koreksi',$value['tanggal_koreksi'])->update($data_update);
                    }
                    else{
                        $data_insert=[
                            'uuid' => Str::uuid(),
