...
class PermintaanTenagaKerjaController extends AdminBaseController
{
    ...
    public function ajax_data_permintaan_tk(Request $request)
    {
        ...
        $status = $request->input('is_verifikasi_pengajuan_tk');
        $search = $request->input('search.value');

        // Query pertama
        $data = DB::table('pengajuan_permintaan_tk')
            ->select(
                'employee_atribut.employee_name',
                'employee_atribut.nik',
            ...
            ->where('pengajuan_permintaan_tk.is_verifikasi_pengajuan_tk', $status)->get();
