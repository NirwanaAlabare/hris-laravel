...
class ProsesPayrollController extends AdminBaseController
{
        ...
        if(request()->periode_payrols){
            ...
            if($periode_umk!='2024-2025'){
                ...
                foreach($rekap_payroll as $key=>$value){
                    ...
                    $Bpjs=EmployeeBpjs::where('enroll_id',$value->enroll_id)->where('periode_kehadiran',$priode)->first();
                    $koreksi_upah_mandiri=DataKoreksiUpah::where('enroll_id',$value->enroll_id)->where('periode_tanggal_koreksi',$periode_payroll2)->where('is_verifikasi_acc', 1)->where(function($query){
                    ...
                    $koreksi_potongan_mandiri=DataKoreksiPotongan::where('enroll_id',$value->enroll_id)->where('periode_tanggal_koreksi',$periode_payroll2)->where('is_verifikasi_acc', 1)->get();
    ...
    public function jurnal2()
   {
    ...
    public function potongan($periode_payroll)  {
        $DataKoreksiPotongan=DataKoreksiPotongan::where('periode_tanggal_koreksi',$periode_payroll)->where('is_verifikasi_acc', 1)->get();
            $data=[];
    ...
    public function koreksi($periode_payroll)  {
        $DataKoreksiUpah=DataKoreksiUpah::where('periode_tanggal_koreksi',$periode_payroll)->where('is_verifikasi_acc', 1)->get();
            $data=[];
