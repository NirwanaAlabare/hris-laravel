        ...
        foreach($master_absen as $key=>$value){
            ...
            $z=[
                ...
                round(
                    (
                        ceil(
                            ((
                                    (
                                        ($value->mulai_jam_kerja!=null?$gaji_perhari:0)+round($tunjangan/$jumlah_hari_kerja,2)+
                ...
                'jumlah'=>($value->kode_hari!=5 && $value->kode_hari!=6)?
                        (
                            (($value->mulai_jam_kerja!=null?$gaji_perhari:0)+
