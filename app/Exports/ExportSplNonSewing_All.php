...
class ExportSplNonSewing_All implements FromView, WithEvents, ShouldAutoSize, WithColumnWidths
{
    use Exportable;
    ...
    public function view(): View
    {
	    ...
	    inner join (select * from master_data_absen_kehadiran where tanggal_berjalan >= '$this->from' and tanggal_berjalan <= '$this->to') m on b.enroll_id = m.enroll_id and a.tgl_lembur = m.tanggal_berjalan order by tgl_lembur asc,dept asc, employee_name asc
        ");
        ...
        return view('hris/mutasi-karyawan/form-lembur-sewing/export_spl_non_sewing_all', [
            'data' => $data,
            'from' => $this->from,
            'to' => $this->to
        ]);
