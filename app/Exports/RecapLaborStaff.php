...
class RecapLaborStaff implements WithTitle, FromView, WithColumnWidths
{
    ...
    public function view(): View
    {
        ...
        return view('hris.recap_labor_staff',compact('x','dateRange'));
    }
