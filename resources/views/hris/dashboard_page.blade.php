                ...
                <div class="" style="background-color: #FFF">
                    <div class="card-body p-0">
                        <div class="row">
                            ...
                            @endif
                            @if ($modul=='all' && ( $email == 'mega@ptnag.com' || $email == 'ersa@ptnag.com' || $email == 'pujiprana@nag.nirwanaindonesia.com' || $email == 'indri@nag.nirwanaindonesia.com' || $email == 'rudy@ptnag.com' || $email == 'fadli'  || $email == 'ronald@ptnag.com' || $email == 'hadiyoso@nag.nirwanaindonesia.com' || $email == 'bobby' || $email == 'ramon'))
                                <div class="col">
