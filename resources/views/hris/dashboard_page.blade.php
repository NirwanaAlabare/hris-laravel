            ...
            <div class="col-auto">
                <div class="" style="background-color: #FFF">
                    <div class="card-body p-0">
                        <div class="row">
                            @if ($modul=='all' || $modul=='attendance_payroll' || $email == 'alex.herdian@ptnag.com' || $email == 'willy@ptnag.com' || $email == 'reza' || $modul == 'attendance_payroll_general_affair_administrasi')
                            ...
                            @endif
                            @if ($modul=='all' && ( $email == 'mega@ptnag.com' || $email == 'ersa@ptnag.com' || $email == 'pujiprana@nag.nirwanaindonesia.com' || $email == 'indri@nag.nirwanaindonesia.com' || $email == 'rudy@ptnag.com' || $email == 'dev_hris'  || $email == 'ronald@ptnag.com' || $email == 'hadiyoso@nag.nirwanaindonesia.com' || $email == 'bobby' || $email == 'ramon'))
                                <div class="col">
