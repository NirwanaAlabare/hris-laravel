            ...
            <div id="data-gagal-absen" class="card shadow" id="datatable-data-karyawan">
                ...
                <div class="card-body pt-0">
                    ...
                    <table class="table table-striped table-sm mb-0">
                        <tr>
                            <th class="w-35"></th>
                            <td class="w-65" align="right"><input type="text" class="form-control form-control-sm col-1" id="grading_salary_id" name="grading_salary_id" readonly></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th class="w-35">INSENTIF</th>
                            <td class="w-65"><input type="text" class="form-control" id="insentif" name="insentif"></td>
                        </tr>
                        <tr>
