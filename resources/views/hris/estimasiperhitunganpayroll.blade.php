...
@section('mainarea')
    ...
    <div class="page-header p-2 shadow">
        <ol class="breadcrumb breadcrumb-arrow mt-0">
            ...
            <li class="active"><span>Estimasi Payroll Karyawan</span></li>
        </ol>
        <div class="ml-auto">
    ...
    <!-- BEGIN FORM-->
    {!! Form::open(['route' => 'hris.estimasinilaipayroll.export', 'id' => 'formExport', 'name' => 'formExport','method'=>'post']) !!}

    @csrf
    <input id="selDepVal" name="selDepVal" type="hidden">
    <div class="card shadow">
        <div class="card-header bg-primary p-2">
            <div class="card-title">FILTER DATA ESTIMASI PAYROLL KARYAWAN</div>
