...
<body>
    ...
    <thead>
        ...
        <tr>
            <td></td>
            <td style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif;text-align:justify" colspan="4">Demikian Surat Keterangan ini dibuat dengan menggunakan <u><b>tanda tangan basah dan cap perusahaan</b></u> untuk dapat diketahui dan diproses.</td>
            <td></td>
        </tr>
        <tr>
        ...
        <table width="562">
            <thead >
                <tr>
                    ...
                    <td rowspan="2"><img src="data:image/png;base64,{{ \DNS2D::getBarcodePNG(url('hris/identity/card_employee_form_identity') . '?enroll_id=' . $value->enroll_id . '&no_form=' . urlencode($no_form)  . '&type=SK_BNI', 'QRCODE') }}"  alt="barcode" style="width: 60px; height: 60px;background-color:white" /></td>
                </tr>
                <tr>
