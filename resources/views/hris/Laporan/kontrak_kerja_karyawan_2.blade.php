...
<body>
   <table class="purchase-order" width="100%" style="margin-top:26px;">
        ...
        <tr>
            <td>
                <ol style="font-family:Arial, Helvetica, sans-serif;font-size:7pt;text-align:justify;padding-left:20px">
                    ...
                    <li><b>PIHAK PERTAMA</b> akan membayar Upah/Gaji pokok kepada <b>PIHAK KEDUA</b> sebesar <b>{{number_format($value->umk, 2, ',', '.');}}</b> <i><b>({{ ucwords(strtolower($value->umk_latin)) }})</b></i>, yang perhitungannya dipengaruhi oleh penilaian tingkat kemampuan, kehadiran, serta jenis pekerjaan yang dilakukan. Pembayaran upah / gaji akan dilaksanakan pada tanggal 1 (satu) setiap bulannya.</li>
    ...
    <table width="527" style="line-height: 8px;padding-top:8px">
        <thead>
            <tr>
                <td style="font-family:Arial, Helvetica, sans-serif;font-size:7pt">Bandung, {{Carbon\Carbon::parse($contract2)->translatedFormat('d F Y')}}</td>
            </tr>
            <tr>
    ...
    <table width="527" style="margin-top:-5px;">
        <thead>
            <tr>
                ...
                <td style="font-family:Arial, Helvetica, sans-serif;font-size:7.3pt;font-weight:bold;"><b>Bandung, <u>{{Carbon\Carbon::parse($contract2)->translatedFormat('d F Y')}}</u></b></td>
            </tr>
            <tr>
                <td></td>
