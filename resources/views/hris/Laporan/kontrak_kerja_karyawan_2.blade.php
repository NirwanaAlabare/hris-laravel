        ...
        <tr>
            <td>
                <ol style="font-family:Arial, Helvetica, sans-serif;font-size:7.5pt;text-align:justify;padding-left:20px;margin-top:0px;margin-bottom:0px">
                    ...
                    <li><b>PIHAK KEDUA</b> menyatakan bersedia mengikuti jadwal kerja yang telah ditentukan yaitu Senin s/d Jumat pukul <b>{{ date('H:i', strtotime($value->mulai_jam_kerja)) }} s/d {{ date('H:i', strtotime($value->akhir_jam_kerja)) }}</b>, atau ditentukan lain oleh <b>PIHAK PERTAMA</b>.</li>
