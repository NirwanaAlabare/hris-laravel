...
<?php ini_set('date.timezone', 'Asia/Jakarta'); ?>
    <div class="page-header shadow pr-2 m-0 pt-0 pb-0 pl-2">
        <ol class="breadcrumb breadcrumb-arrow m-0 p-0">
            <li><a href="{{route('entertaint_tamu.index')}}">Grading</a></li>
            <li class="active"><span>Pengajuan Kenaikan Grading</span></li>
        ...
        <div class="col-md-12">
            <div class="card card-primary card-outline tab-content">
                    <div class="card-header bg-primary p-3">
                        <div class="card-title">Pengajun Kenaikan Grading</div>
                    </div>
                        <div class="mt-4 ml-4 mr-5 mb-0">
                            <div class="row">
                                <div class="col-md-12">
                                    <div clasl="" style="display: flex; justify-content: space-between; align-items: center; gap: 10px;">
                                        <div style="display:flex; gap:10px; align-items:center;" class="mt-3">
                                            <button class="btn btn-primary"
                                                onclick="openModalBuatPengajuan()">
                                            ...
                                            <button class="btn btn-success" id="btn-import-excel">
                                                    ...
                                                    <table id="datatable-ajax-crud-waiting" class="table table-sm table-striped table-hover table-bordered w-100">
                                                        <thead>
                                                            <tr class="text-center">
                                                                ...
                                                                <th scope="col">Kode Grade Sebelumnya</th>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                                        ...
                                        <select id="diajukanOlehID" name="diajukanOlehID" style='width: 100%;' data-placeholder="Pilih karyawan" class="form-control create-control select2 select2-show-search EmployeeID">
                                            ...
                                            @foreach ($selectemployee as $r_empl)
                                                <option
                                                    ...
                                                    data-kode_grade="{{$r_empl->kode_grade}}"
                                                >
                            ...
                            <div id="container-kualifikasi">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="form-label">Kode Grade Lama : </label>
                                        <input type="text" readonly value="" class="form-control create-control" id="kode_grade" name="kode_grade">
                                        <input type="hidden" readonly value="" class="form-control create-control" id="kode_grade" name="kode_grade">
                                    </div>
                                </div>
                                    {{-- <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-label">Kode Grade baru : </label>
                                            <select id="kode_grade_baru" name="kode_grade_baru" class="form-control">
                                                <option value="">-- Kode Grade --</option>
                                                @foreach ($grading as $r_grading)
                                                    <option value="{{$r_grading->kode_grade}}">{{$r_grading->kode_grade}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="diajukanOlehIDModalApprove" name="diajukanOlehIDModalApprove" style='width: 100%;' data-placeholder="Pilih karyawan" class="form-control create-control select2 select2-show-search EmployeeID" disabled>
                                            <option value="">-- Pilih Karyawan --</option>
                                            @foreach ($selectemployee as $r_empl)
                                                <option
                                                    value="{{$r_empl->enroll_id}}"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label class="form-label">Kode Grade Lama : </label>
                                        <input type="text" readonly value="" class="form-control create-control" id="kode_grade1" name="kode_grade1">
                                        <input type="hidden" readonly value="" class="form-control create-control" id="kode_grade1" name="kode_grade1">
                                    </div>
                                </div>
                                    {{-- <div class="col-md-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="form-label">Kode Grade baru : </label>
                                             <input type="text" readonly value="" class="form-control create-control" id="kode_grade_baru1" name="kode_grade_baru1">
                                            <input type="hidden" readonly value="" class="form-control create-control" id="kode_grade_baru1" name="kode_grade_baru1">
                                            {{-- <select id="kode_grade_baru1" name="kode_grade_baru1" class="form-control"  readonly>
                                                <option value="">-- Kode Grade --</option>
                                                @foreach ($grading as $r_grading)
                                                    <option value="{{$r_grading->kode_grade}}">{{$r_grading->kode_grade}}</option>
                                                @endforeach
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Periode : </label>
                                             <input type="text" readonly value="" class="form-control create-control" id="periode1" name="periode1">
                                            <input type="hidden" readonly value="" class="form-control create-control" id="periode1" name="periode1">
                                            {{-- <select id="periode1" name="periode1" class="form-control"  readonly>
                                                <option value="">--periode --</option>
                                                @foreach ($periode_payroll as $r_periode_payroll)
                                                    <option value="{{$r_periode_payroll->periode_kehadiran}}">{{$r_periode_payroll->periode_kehadiran}}</option>
                                                @endforeach
...
$('#file-excel').change(function () {
    ...
    $.ajax({
        url: "{{ route('hris.gradingsalarybaru.import') }}",
        type: "POST",
        data: formData,
    ...
    $.ajax({
        type: "POST",
        url: "{{ route('hris.gradingsalarybaru.get_detail_grading') }}",
        data: {
            id: id
        },
        success: function(res) {
            ...
            $('#id').val(data.id_grade);
            $('#enroll_id_approve').val(data.enroll_id);
            $('#tanggal_pengajuan_approve').val(data.tanggal_pengajuan);

            $('#diajukanOlehIDModalApprove')
            .val(data.enroll_id)
            .trigger('change');
            ...
            $('#bagian_approve').val(data.sub_dept_name);
            $('#sub_dept_id_approve').val(data.sub_dept_id);
            $('#kode_grade1').val(data.kode_grade_lama);
            // $('#kode_grade1').val(data.kode_grade_lama);
            $('#kode_grade_baru1').val(data.kode_grade_baru);

            $('#periode1').val(data.periode_payroll);
        ...
        var loginEmail = "{{ Auth::guard('admin')->user()->email }}";
        ...
        $(document).ready(function() {
            ...
            var tableWaiting = $('#datatable-ajax-crud-waiting').DataTable({
                ajax: {
                    url: '{{ route('hris.gradingsalarybaru.ajax_data') }}',
                    type: "POST",
                    data: function(d) {
                        d.verifikasi = '0';
                ...
                { data: 'kode_grade_baru', name: 'grading_history.kode_grade_baru' },
                { data: 'periode_payroll', name: 'grading_history.periode_payroll',
                render: function(data){ if(!data)return '-'; var endDate = data.split('s/d')[1];return moment(endDate).format('MMMM YYYY');}
                 },
                { data: 'operator', name: 'grading_history.operator'
                },
                {
                    data: null,
                    orderable: false,
                  ...
                  render: function (data, type, row) {
                        ...
                        var tombol = `
                            <button class="btn btn-sm mr-1 btn-danger" onclick="printPengajuanPDF('${row.id_grade}')">
                                <i class="fa fa-file-pdf-o"></i>
                            </button>

                            <button class="btn btn-sm mr-1 btn-primary" onclick="openModalEditPengajuan('${row.id_grade}')">
                        ...
                        if (approvalUser.includes(loginEmail)) {
                            tombol += `
                                <button class="btn btn-sm mr-1 btn-success" onclick="openModalApprovePengajuan('${row.id_grade}')">
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                                ...
                                let btnClass;
                                    return `
                                        <button class="btn btn-sm mr-1 btn-danger" onclick="printPengajuanPDF('${row.id}')">
                                <i class="fa fa-file-pdf-o"></i>
                            </button>

                            <button class="btn btn-sm mr-1 btn-primary" onclick="openModalEditPengajuan('${row.id}')">
                                <i class="fa fa-edit"></i>
                            </button>

                            <button class="btn btn-sm mr-1 btn-danger" id="btn-remove" data-id_pengajuan="${row.id}">
                                <i class="fa fa-trash"></i>
                            </button>
                                    `;
                        }
            ...
            $('body').on('click', '#btn-remove', function (event) {
                ...
                swal({
                    ...
                    if(isConfirm) {
                        $.ajax({
                            type:"POST",
                            url: "{{route('hris.gradingsalarybaru.delete_pengajuan_grading')}}",
                            dataType: 'json',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                            data: {
...
$('#tab-reject').click(function () {
    ...
    window.location.href = url;
            ...
            $('body').on('click', '#btn-approve-permintaan', function (event) {
                ...
                $.ajax({
                    type:"POST",
                    url: "{{route('hris.gradingsalarybaru.approve_grading')}}",
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                    data: {
                        id:id,
            ...
            $('body').on('click', '#btn-simpan-permintaan', function (event) {
                ...
                var tanggal_fix = tanggal_pengajuan.substr(6,4) + '-' + tanggal_pengajuan.substr(3,2) + '-' + tanggal_pengajuan.substr(0,2);

                var enroll_id = $('#diajukanOlehID').val();
                var department_id = $('#department_id').val();
                var sub_dept_id = $('#sub_dept_id').val();
                var kode_grade_lama = $('#kode_grade').val();

                var kode_grade_baru = $('.kualifikasi-item').find('select[name="kode_grade_baru"]').val();
                var periode = $('.kualifikasi-item').find('select[name="periode"]').val();

                if(!enroll_id){
                    swal("", "Harap pilih karyawan!", "warning");
                    return;
                }

                if(!kode_grade_baru){
                    swal("", "Harap pilih kode grade baru!", "warning");
                    return;
                }

                if(!periode){
                    swal("", "Harap pilih periode!", "warning");
                    return;
                }

                $.ajax({
                    type: "POST",
                    url: "{{ route('hris.gradingsalarybaru.create') }}",
                    dataType: 'json',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    },
                    data: {
                        tanggal_pengajuan: tanggal_fix,
                        enroll_id: enroll_id,
                    ...
                    error: function (xhr) {
                        let message = "Oops data gagal disimpan.";
