...
@section('mainarea')
    ...
    <div class="page-header p-3 shadow">
        <ol class="breadcrumb breadcrumb-arrow mt-0">
            ...
            <li class="active"><span>VERIFIKASI INSENTIF LEMBUR</span></li>
        </ol>
        <div class="ml-auto">
            <div class="input-group">
                ...
                <a href="{{route('hris.verifikasi_insentif_lembur.add_verifikasi_insentif_lembur')}}" id="btn-add-data-lembur" class="btn btn-warning text-white mr-2 btn-icon" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Tambah Data Lembur">
                    <span>
    ...
    <!-- BEGIN FORM-->
    {!! Form::open(['route' => 'hris.verifikasi_insentif_lembur.ajax_exportexcel', 'id' => 'formExport', 'name' => 'formExport','method'=>'post']) !!}
    ...
    <div class="modal fade" id="ajax-modal-verifikasi_insentif_lembur" role="dialog" data-backdrop="static" aria-hidden="true">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-sm table-striped table-bordered table-vcenter text-nowrap table-nowrap w-100 m-0 p-0">
                                                ...
                                                <tbody id="crudverifikasi_insentif_lembur">
                                                </tbody>
                                            </table>
                                        </div>
                                        <div class="row">
                                    ...
                                    <div class="card-body br-br-7 br-bl-7">
                                        <div class="table-responsive">
                                            <table class="table table-sm table-striped table-bordered table-vcenter text-nowrap table-nowrap w-100 m-0 p-0">
                                                ...
                                                <tbody id="crudverifikasi_insentif_lemburverify">
                                                </tbody>
                                            </table>
                                        </div>
                                    </div>
...
@section('footerjs')
    ...
    <script type="text/javascript">
        ...
        function getallnomorspl()
        {
            ...
            if(periode_lembur){
                $.ajax({
                    type:"POST",
                    url: "{{route('hris.verifikasi_insentif_lembur.ajax_getnomorspl')}}",
                    dataType: 'json',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                    data: {
        ...
        $('body').on('change', '#daterange1', function () {
            ...
            if(daterange1){
                $.ajax({
                    type:"POST",
                    url: "{{route('hris.verifikasi_insentif_lembur.ajax_gettanggalnfl')}}",
                    dataType: 'json',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                    data: {
        ...
        $('body').on('change', '#selectNomorFormLembur', function () {
            ...
            if(nomor_form_lembur.length > 0){
                ...
                $.ajax({
                    type:"POST",
                    url: "{{route('hris.verifikasi_insentif_lembur.ajax_getemployeselectnfl')}}",
                    dataType: 'json',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                    data: {
        ...
        $('body').on('change', '#selectDepartment', function () {
            ...
            if(department_id.length > 0){
                ...
                $.ajax({
                    type:"POST",
                    url: "{{route('hris.verifikasi_insentif_lembur.ajax_getemployeselectdeptid')}}",
                    dataType: 'json',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                    data: {
        ...
        $('body').on('click', '#btn-save-changes', function (event) {
            ...
            $.ajax({
                type:"POST",
                url: "{{route('hris.verifikasi_insentif_lembur.update')}}",
                dataType: 'json',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                data: {
        ...
        $('body').on('click', '#btn-delete-lembur', function (event) {
            ...
            $.ajax({
                type:"POST",
                url: "{{route('hris.verifikasi_insentif_lembur.delete')}}",
                dataType: 'json',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                data: {
        ...
        $('body').on('click', '#verificating', function () {
            ...
            $.ajax({
                type:'POST',
                url:"{{route('hris.verifikasi_insentif_lembur.verificating')}}",
                data:{all_uuid:alluuid},
                success:function(data){
                    $("#verif_confirm").modal('hide');
                    $("#ajax-modal-verifikasi_insentif_lembur").modal('hide');
                }
            });
        });
        ...
        $('body').on('click', '#btn-search', function () {
            $("#crudverifikasi_insentif_lembur").empty();
            $("#crudverifikasi_insentif_lemburverify").empty();
            var periode_lembur = $('#periode_lembur').val();
            var selectNoSPL = $('#selectNoSPL').val();
            var searchData = $('#searchData').val();
            $("#ajax-modal-verifikasi_insentif_lembur").modal('show');
            $.ajax({
                type:'POST',
                url:"{{route('hris.verifikasi_insentif_lembur.ajax_verifikasi_insentif_lembur2')}}",
                ...
                success:function(data){
                    ...
                    for(i=0;i<data.length;i++) {
                        ...
                        if (data[i].data_lembur.is_verifikasi==0) {
                            ...
                            $("#crudverifikasi_insentif_lembur").append(htmlTable);
                        }
                        else{
                            htmlTable2 = '' +
                            '<tr class="text-center">' +
                            ...
                            $("#crudverifikasi_insentif_lemburverify").append(htmlTable2);
                        }
                    }
                        ...
                        swal({
                            ...
                            if(isConfirm) {
                                if(hapusData){
                                    ...
                                    $.ajax({
                                        type:"POST",
                                        url: "{{route('hris.verifikasi_insentif_lembur.remove')}}",
                                        headers: {
                                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                                        data: {
        ...
        $('body').on('click', '#btn-update_edit1', function (event) {
            ...
            if(checkAll) {
                $.ajax({
                    type:"POST",
                    url: "{{route('hris.verifikasi_insentif_lembur.updatelemburall')}}",
                    dataType: 'json',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                    data: {
                ...
                $.ajax({
                    type:"POST",
                    url: "{{route('hris.verifikasi_insentif_lembur.updatelembur')}}",
                    dataType: 'json',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                    data: {
        ...
        function getemployee() {
            var table1 = $('#datatable-ajax-modal2').DataTable({
                ...
                destroy: true,
                "ajax": {
                    "url": "{{ route('hris.verifikasi_insentif_lembur.ajax_getemployee') }}",
                    "dataType": "json",
                    "type": "POST",
                    "headers": {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $('body').on('click', '#btn-save2', function (event) {
            ...
            $.ajax({
                type:"POST",
                url: "{{route('hris.verifikasi_insentif_lembur.tambahkaryawan')}}",
                dataType: 'json',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                data: {
            ...
            swal({
                ...
                if(isConfirm) {
                    if(selectNoSPL){
                        ...
                        $.ajax({
                            type:"POST",
                            url: "{{route('hris.verifikasi_insentif_lembur.removenospl')}}",
                            dataType: 'json',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                            data: {
    ...
    <script>
        $('#verifikasi').submit(function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('hris.verifikasi_insentif_lembur.verifikasi')}}",
                data: $(this).serialize(),
        ...
        function TampilDataLembur() {
            ...
            if(periode_lembur){
                ...
                $.ajax({
                    type:"POST",
                    url: "{{route('hris.verifikasi_insentif_lembur.ajax_verifikasi_insentif_lembur')}}",
                    dataType: 'json',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                    data: {
                        ...
                        if(res.length > 0){
                            ...
                            for(i=0;i<res.length;i++) {
                                ...
                                if (res[i].data_lembur.is_verifikasi==1) {
                                    ...
                                    var url = "{{ route('hris.verifikasi_insentif_lembur.unverifikasi',['uuid'=>'random_id']) }}";
