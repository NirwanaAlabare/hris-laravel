        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (dayOfWeek === 5) { // Jumat
                    last_date.setDate(last_date.getDate()); // mundur ke Jumat
                } else if (dayOfWeek === 6) { // Sabtu
                    last_date.setDate(last_date.getDate() - 1); // mundur ke Jumat
                } else if (dayOfWeek === 0) { // Minggu
                    last_date.setDate(last_date.getDate() - 2); // mundur ke Jumat
                }
