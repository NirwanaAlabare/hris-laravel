        ...
        <table border="1">
            ...
            @foreach ($grouped as $enrollId => $contracts)
                ...
                <tr>
                    ...
                    <td style="border:1px solid black">{{ \Carbon\Carbon::parse($first->contract)->translatedFormat('d F Y') }} - {{ \Carbon\Carbon::parse($first->tanggal_pengurang)->translatedFormat('d F Y') }}</td>
                    {{-- Masa Kerja --}}
