    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 ">
            ...
            <div id="data-lembur" class="card shadow tab-content">
                <div class="card-header bg-primary p-3">
                    <div id="title-table1" class="card-title">DATA LEMBUR KARYAWAN sssssssssss</div>
                    <div class="card-options">
                        <a href="#" class="card-options-collapse mr-2" data-toggle="card-collapse"><i class="fe fe-chevron-up text-white"></i></a>
                    </div>
                </div>
...
@section('footerjs')
    ...
    <script type="text/javascript">
        ...
        //                             '   <td> <input type="checkbox" class="checked" name="uuid[]"  value="'+res[i].uuid+'">'+'</td>'+
                        ...
                        if(res.length > 0){
                            ...
                            for(i=0;i<res.length;i++) {
                                if (res[i].is_verifikasi==0) {
                                    ...
                                    '   <td> <input type="checkbox" class="checked" name="uuid_master2[]"  value="'+res[i].uuid+'">'+'</td>'+
