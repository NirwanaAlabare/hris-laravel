                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group w-100">
                                    ...
                                    @if ($username == 'HR' || $username == 'IT' || $username == 'Gaga' || $username == 'dev_hris' || $username == 'rudy' || $username == 'Ersa Regina Nugraha')
                    ...
                    columnDefs: [{
                        ...
                        render: (data, type, row, meta) => {
                            if(row.enroll_id!=null){
                                if($('#username_who_access').val()=='HR' || $('#username_who_access').val()=='IT'|| $('#username_who_access').val()=='Gaga'|| $('#username_who_access').val()=='dev_hris'|| $('#username_who_access').val()=='Rudy Aristian Fajar'|| $('#username_who_access').val()=='Ersa Regina Nugraha' ){
