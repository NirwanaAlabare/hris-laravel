    ...
    @if (
        ...
        <tfoot>
            ...
            <tr>
                ...
                <td colspan="2" style="text-align: center;text-decoration: underline;">SPV/ Chief</td>
                <td colspan="2" style="text-align: center;text-decoration: underline;">Manager Produksi</td>
                <td colspan="3" style="text-align: center;text-decoration: underline;">General Manager</td>
    ...
    @else
        ...
        <tfoot>
            ...
            <tr>
                ...
                <td colspan="2" style="text-align: center;text-decoration: underline;">SPV/ Chief</td>
                <td colspan="2" style="text-align: center;text-decoration: underline;">Manager Produksi</td>
                <td colspan="2" style="text-align: center;text-decoration: underline;">PPIC Manager</td>
                <td colspan="3" style="text-align: center;text-decoration: underline;">General Manager</td>
                <td colspan="2" style="text-align: center;text-decoration: underline;">HRD</td>
            </tr>
        </tfoot>
