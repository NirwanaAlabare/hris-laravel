...
<html lang="en">
    <table class="table">
        ...
        <tr>
            ...
            <td colspan="1" rowspan="2" style="vertical-align: middle;font-weight:bold;background-color:#b8cce4;border:1px solid black;">Kode Departemen</td>
            ...
            <td colspan="1" rowspan="2" style="vertical-align: middle;font-weight:bold;background-color:#b8cce4;border:1px solid black;">Kode Bagian</td>
        ...
        <tr>
            ...
            <td style="vertical-align: middle;border:1px solid black;word-wrap:break-word;">{{$data->dept}}</td>
            <td style="vertical-align: middle;border:1px solid black;word-wrap:break-word;">{{$data->sub_dept_name}}</td>
            <td style="vertical-align: middle;border:1px solid black;word-wrap:break-word;">{{$data->sub_dept}}</td>
