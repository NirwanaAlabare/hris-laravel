...
<html lang="en">
    <table class="table">
        ...
        <tr>
            <td>{{Carbon\Carbon::parse($dateFrom)->translatedFormat('l, j F Y')}}</td>
        </tr>
        <tr>
            <td></td>
        </tr>
        <tr>
            <td colspan="2" rowspan="2" style="vertical-align: middle;font-weight:bold;background-color:#b8cce4;border:1px solid black;">Keterangan</td>
        ...
        <tr>
            <td style="vertical-align: middle;font-weight:bold;background-color:#fffc04;border:1px solid black;" colspan="2">{{$data->shift}}</td>
        ...
        <tr>
            <td style="vertical-align: middle;font-weight:bold;background-color:#ffc404;border:1px solid black;" colspan="2">{{$data->shift}}</td>
