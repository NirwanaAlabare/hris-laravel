								...
								<div class="card">
									...
									<div class="text-center">
										<div class="row">
											...
											<div class="col-lg-2 col-md-4">
												<div class="card-body ">
													<span class="pie" data-peity='{ "fill": ["var(--primary)  ", "#ebe9f7"]}'>226/360</span>
												</div>
											</div>
											<div class="col-lg-2 col-md-4">
												<div class="card-body ">
								...
								<div class="card">
									...
									<div class="text-center">
										<div class="row">
											...
											<div class="col-lg-2 col-md-4">
												<div class="card-body ">
													<span class="donut" data-peity='{ "fill": ["var(--primary)  ", "#ebe9f7"]}'>226/360</span>
												</div>
											</div>
											<div class="col-lg-2 col-md-4">
												<div class="card-body ">
								...
								<div class="card">
									...
									<div class="text-center">
										<div class="row">
											<div class="col-lg-4">
												<div class="card-body ">
													<span class="peity-line" data-peity='{ "fill": ["var(--primary)"],"stroke":["var(--primary)"]}' data-width="100%">6,2,8,4,3,8,1,3,6,5,9,2,8,1,4,8,9,8,2,1</span>
												</div>
											</div>
											<div class="col-lg-4">
												<div class="card-body ">
								...
								<div class="card">
									...
									<div class="text-center">
										<div class="row">
											<div class="col-lg-4">
												<div class="card-body ">
													<span class="bar" data-peity='{ "fill": ["#13DAFE", "var(--primary)  "]}'>6,2,8,4,3,8,1,3,6,5,9,2,8,1,4,8,9,8,2,1</span>
												</div>
											</div>
											<div class="col-lg-4">
												<div class="card-body ">
									...
									<div class="text-center">
										<div class="row">
											...
											<div class="col-lg-2 col-md-4">
												<div class="card-body ">
													<p class="data-attributes">
														<span data-peity='{ "fill": ["var(--primary)  ", "#ebe9f7"], "innerRadius": 14, "radius": 36 }'>2/7</span>
													</p>
												</div>
											</div>
											<div class="col-lg-2 col-md-4">
							...
							<div class="col-lg-12 col-md-12">
								<div class="card">
									...
									<div class="card-body text-center">
										<span class="updating-chart" data-peity='{ "fill": ["var(--primary)"],"stroke":["var(--primary)"]}'>5,3,9,6,5,9,7,3,5,2,5,3,9,6,5,9,7,3,5,2</span>
									</div>
								</div>
							</div>
						</div>
